...
import com.zupfood.livraria.autor.AutorInexistenteException;
import com.zupfood.livraria.autor.AutorRepository;
import com.zupfood.livraria.categoria.CategoriaInexistenteException;
import com.zupfood.livraria.categoria.CategoriaRepository;
...
public class LivroDto {
    ...
    public LivroDto(Long id, String titulo, LocalDate dataDeLancamento, String resumo,
                    ...
                    int paginas, LocalDate alterado) {
        this.id = id;
        this.titulo = titulo;
        this.dataDeLancamento = dataDeLancamento;
        this.resumo = resumo;
